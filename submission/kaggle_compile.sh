...
python3 ./submission/kaggle_compile.py ./src_james/solver_multimodel/main.py | tee ./submission/submission.py
#python3 ./submission/kaggle_compile.py src_james/ensemble/sample_sub/sample_sub_combine.py | tee ./submission/submission.py
