...
T = TypeVar('T', bound='GameOfLifeForward_4')
class GameOfLifeForward_4(GameOfLifeBase):
    """
    ...
    def __init__(self):
        ...
        self.layers = nn.ModuleList([
            ...
            nn.Conv2d(in_channels=1,    out_channels=4,    kernel_size=(3,3), padding=1, padding_mode='circular'),
            nn.Conv2d(in_channels=1+4,  out_channels=4,    kernel_size=(1,1)),
